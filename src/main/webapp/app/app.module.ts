...
import { GatewayServiceSharedModule, UserRouteAccessService } from './shared';
import { GatewayServiceAppRoutingModule} from './app-routing.module';
import { GatewayServiceHomeModule } from './home/home.module';
import { GatewayServiceAdminModule } from './admin/admin.module';
import { GatewayServiceAccountModule } from './account/account.module';
...
@NgModule({
    imports: [
        ...
        GatewayServiceAdminModule,
        GatewayServiceAccountModule,
